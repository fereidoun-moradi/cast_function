...
Note: The cast function has an option that can get a list of variables as an input list and put the values of the variables on the transtions of the mapped state space. 
